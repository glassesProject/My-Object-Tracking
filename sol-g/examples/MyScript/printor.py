...
def print_png():
    ...
    # 画像読み込み
    img = Image.open("result_newspaper.png")
    ...
    hDC.StartDoc("result_newspaper.png")
    hDC.StartPage()

    # 左上から描画（マージン未調整でよければ (0,0) でOK）
    dib.draw(hDC.GetHandleOutput(), (0, 0, target_width, target_height - 150))
...
#     # テスト対象のファイル
#     test_file = "result_newspaper.png"  # ← ここに印刷したいファイル名を指定
...
#             print(f"印刷中にエラーが発生しました: {e}") 5EMERrvr
