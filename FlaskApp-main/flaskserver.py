#ファイル名がパッケージ名と同じになるとエラーが発生するのでflaskserverに変更
...
EXTERNAL_JSON_PATH = os.path.join(BASE_DIR, 'state', 'external_status.json')
# IMAGE_PATH = os.path.join(BASE_DIR, 'static', 'images', 'generated_image.jpg')
IMAGE_PATH = os.path.join(BASE_DIR, 'static', 'images', 'generated_image.jpg')  # フルパスに修正
